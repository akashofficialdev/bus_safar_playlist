...
const retroPlaylistId = "PLMBRj2KNZFBc";
const retroPlaylistUrl = `https://music.youtube.com/playlist?list=${retroPlaylistId}`;
...
const playlists: Playlist[] = [
  ...
  {
    id: "baarish-seat",
    name: "📼 80s-90s Retro Safar",
    shortName: "80s-90s Retro",
    accent: "#e9c46a",
    description: "Classic 80s and 90s Hindi songs for the long road.",
    youtubePlaylistId: retroPlaylistId,
    youtubePlaylistUrl: retroPlaylistUrl,
    tracks: [
      ["Saagar Jaisi Aankhonwali", "Kishore Kumar", "80s classic", "PFHczgD-lGM"],
      ["Dilbar Mere", "Kishore Kumar", "80s romance", "uFaaqPv6dn4"],
      ["Tera Naam Liya", "Manhar Udhas", "retro duet", "H3R9038hmvc"],
      ["Nazar Ke Samne", "Anuradha Paudwal", "90s melody", "hHZqggIcTDU"],
      ["Dil Ka Aalam", "Kumar Sanu", "90s romance", "re55FEKMoAw"],
      ["Bahut Pyar Karte Hai", "S. P. Balasubrahmanyam", "90s classic", "XEggdtDp_4c"],
      ["Mera Dil Bhi Kitna Pagal Hai", "Saajan", "90s heartbreak", "58VwkROgWGI"],
      ["Tumse Milne Ko Dil", "Alka Yagnik", "jhankar", "Q97LLDLxE98"],
      ["Aisi Deewangi", "Alka Yagnik", "90s hit", "H0z31jWUYr4"],
      ["Sochenge Tumhe Pyar", "Kumar Sanu", "90s romance", "eC5riDNidOg"],
      ["Teri Umeed Tera Intezar", "Kumar Sanu", "90s longing", "hUtBXoUzgaM"],
      ["Baazigar O Baazigar", "Kumar Sanu", "90s hit", "6pb1gw2xSD8"],
      ["Tumsa Koi Pyaara", "Kumar Sanu", "90s dance", "fXzm9F4S3d0"],
      ["Raah Mein Unse Mulaqat", "Kumar Sanu", "90s road", "-Tl_FVOx-cs"],
      ["Ek Ladki Ko Dekha", "Kumar Sanu", "90s classic", "Gm6djUDVqf8"],
      ["Aaye Ho Meri Zindagi Mein", "Udit Narayan", "jhankar", "iRR2xQY6S_g"],
      ["Pardesi Pardesi", "Udit Narayan", "90s anthem", "xKb6lP3JxrA"],
      ["Jeeta Tha Jiske Liye", "Kumar Sanu", "90s heartbreak", "O5qahfzGtc8"],
      ["Dil Cheer Ke Dekh", "Kumar Sanu", "90s sad song", "wJTFYAsaLr8"],
      ["Achha Sila Diya", "B Praak", "sad classic", "Frj6n4Qfh8s"],
      ["Teri Gali Vichchon Utthega Janaza Mera", "Sonu Nigam", "sad song", "0aEQyGFEfo8"],
      ["Wafa Na Raas Aayee", "Nitin Mukesh", "sad classic", "NKNP6Bpf95U"],
      ["O Dil Tod Ke Hansti Ho Mera", "Udit Narayan", "sad song", "3_cGT6rXp6w"],
      ["Ishq Mein Hum Tumhein Kya Batayein", "Sonu Nigam", "sad song", "N9n9WYmTDzo"],
      ["Dil Ke Arman Ansuon Men Bah Gaye", "Salma Agha", "80s classic", "aaHpT70bGoE"],
      ["Aankh Hai Bhari Bhari", "Kumar Sanu", "sad duet", "oU7kpTgrUlE"],
